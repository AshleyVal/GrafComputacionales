function sprite() {
  this.width = 8500; // ****el ancho todal de mi spritesheet***
  this.height = 295; // ***el alto de mi spritesheet ***
  this.x = 0;
  this.y = 0;
...
var numberOfFrames = 17; //*** El numero de frames que tiene mi spritesheet***
...
sprite.prototype.draw = function (context) {
  var bobImage = new Image(); //***puedes cambiar el nombre de la variable ***
  bobImage.src = "BobSprite.png"; // ***el nombre de tu imagen***
  update();
  context.save();
  context.translate(this.x, this.y);

  context.drawImage(bobImage,
